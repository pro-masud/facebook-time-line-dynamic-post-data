const userPostFF = document.querySelector(".user-post-here");

let contentHere = '';

members.reverse().map((item, index) => {
    contentHere += `<div class="user-post">
    ...
    <div class="post-comments">
      <div class="comments-header">
        <div class="reaction">
          ...
          <a href="#">Kajal Datta, Sufia Sepu and ${item.link} others</a>
        </div>
        <div class="counts">
...
userPostFF.innerHTML = contentHere;
